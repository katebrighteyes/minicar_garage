...
int main(int argc, char **argv)                 // Node Main Function
{
  ...
  ros::Publisher ros_tutorial_pub = nh.advertise<ros_topic_test::MsgTutorial>("ros_tutorial_msg", 100);

  // Set the loop period. '10' refers to 10 Hz and the main loop repeats at 0.1 second intervals
  ros::Rate loop_rate(10);
  ros_topic_test::MsgTutorial msg;     // Declares message 'msg' in 'MsgTutorial' message file format
